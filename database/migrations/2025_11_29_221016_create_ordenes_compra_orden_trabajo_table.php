...
return new class extends Migration
{
    ...
    {
        Schema::create('ordenes_compra_orden_trabajo', function (Blueprint $table) {
            $table->id();
            $table->foreignId('orden_trabajo_id')->constrained('ordenes_trabajo')->onDelete('cascade');
            $table->string('numero_orden'); // Alegra purchase order number
    ...
    {
        Schema::dropIfExists('ordenes_compra_orden_trabajo');
    }
};
