...
@section('vendor-style')
  @vite(['resources/assets/vendor/libs/fullcalendar/fullcalendar.scss', 'resources/assets/vendor/libs/select2/select2.scss'])
@endsection
...
@section('vendor-script')
  @vite(['resources/assets/vendor/libs/jquery/jquery.js', 'resources/assets/vendor/libs/fullcalendar/fullcalendar.js', 'resources/assets/vendor/libs/select2/select2.js'])
@endsection
            ...
            <div class="col-12 mb-3">
              <div class="card bg-lighter border-0">
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-6">
                      <p class="mb-1"><strong>Estado Actual:</strong> <span id="modal-etapa"
                          class="badge bg-label-primary"></span></p>
