...
use App\Http\Controllers\configuracion\MarcaController;
use App\Http\Controllers\configuracion\ModeloController;
use App\Http\Controllers\configuracion\UsuarioController;
use App\Http\Controllers\ClienteController;
use App\Http\Controllers\VehiculoController;
use App\Http\Controllers\OrdenTrabajoController;
use App\Http\Controllers\TiqueteRepuestosController;
...
Route::middleware([
  ...
  Route::get('/', [DashboardTallerController::class, 'index'])->name('dashboard');
  ...
  Route::prefix('configuracion')->group(function () {
    // Marcas
    Route::middleware('can:gestionar_parametros')->group(function () {
      Route::get('/marcas', [MarcaController::class, 'index'])->name('configuracion-marcas');
      Route::get('/marcas/list', [MarcaController::class, 'list'])->name('configuracion-marcas-list');
      Route::post('/marcas', [MarcaController::class, 'store'])->name('configuracion-marcas-store');
      Route::get('/marcas/{id}', [MarcaController::class, 'show'])->name('configuracion-marcas-show');
      Route::put('/marcas/{id}', [MarcaController::class, 'update'])->name('configuracion-marcas-update');
      Route::delete('/marcas/{id}', [MarcaController::class, 'destroy'])->name('configuracion-marcas-destroy');
    });

    // Modelos
    Route::middleware('can:gestionar_parametros')->group(function () {
      Route::get('/modelos', [ModeloController::class, 'index'])->name('configuracion-modelos');
      Route::get('/modelos/list', [ModeloController::class, 'list'])->name('configuracion-modelos-list');
      Route::post('/modelos', [ModeloController::class, 'store'])->name('configuracion-modelos-store');
      Route::get('/modelos/{id}', [ModeloController::class, 'show'])->name('configuracion-modelos-show');
      Route::put('/modelos/{id}', [ModeloController::class, 'update'])->name('configuracion-modelos-update');
      Route::delete('/modelos/{id}', [ModeloController::class, 'destroy'])->name('configuracion-modelos-destroy');
    });

    // Usuarios
    Route::middleware('can:gestionar_usuarios')->group(function () {
      Route::get('/usuarios', [UsuarioController::class, 'index'])->name('configuracion-usuarios');
      Route::get('/usuarios/list', [UsuarioController::class, 'list'])->name('configuracion-usuarios-list');
      Route::post('/usuarios', [UsuarioController::class, 'store'])->name('configuracion-usuarios-store');
      Route::get('/usuarios/{id}', [UsuarioController::class, 'show'])->name('configuracion-usuarios-show');
      Route::put('/usuarios/{id}', [UsuarioController::class, 'update'])->name('configuracion-usuarios-update');
      Route::delete('/usuarios/{id}', [UsuarioController::class, 'destroy'])->name('configuracion-usuarios-destroy');
    });
  });

  // Clientes
  Route::prefix('clientes')->group(function () {
    Route::get('/', [ClienteController::class, 'index'])->name('clientes')->middleware('can:ver_clientes');
    Route::get('/list', [ClienteController::class, 'list'])->name('clientes-list')->middleware('can:ver_clientes');
    Route::post('/', [ClienteController::class, 'store'])->name('clientes-store')->middleware('can:crear_clientes');
    Route::get('/buscar-alegra', [ClienteController::class, 'buscarEnAlegra'])->name('clientes-buscar-alegra')->middleware('can:crear_clientes');
    Route::get('/{id}', [ClienteController::class, 'show'])->name('clientes-show')->middleware('can:ver_clientes');
    Route::put('/{id}', [ClienteController::class, 'update'])->name('clientes-update')->middleware('can:editar_clientes');
    Route::delete('/{id}', [ClienteController::class, 'destroy'])->name('clientes-destroy')->middleware('can:eliminar_clientes');
  });

  // Vehiculos
  Route::prefix('vehiculos')->group(function () {
    Route::get('/', [VehiculoController::class, 'index'])->name('vehiculos')->middleware('can:ver_vehiculos');
    Route::get('/list', [VehiculoController::class, 'list'])->name('vehiculos-list')->middleware('can:ver_vehiculos');
    Route::get('/modelos', [VehiculoController::class, 'getModelos'])->name('vehiculos-modelos')->middleware('can:ver_vehiculos');
    Route::post('/', [VehiculoController::class, 'store'])->name('vehiculos-store')->middleware('can:crear_vehiculos');
    Route::get('/{id}', [VehiculoController::class, 'show'])->name('vehiculos-show')->middleware('can:ver_vehiculos');
    Route::put('/{id}', [VehiculoController::class, 'update'])->name('vehiculos-update')->middleware('can:editar_vehiculos');
    Route::delete('/{id}', [VehiculoController::class, 'destroy'])->name('vehiculos-destroy')->middleware('can:eliminar_vehiculos');
  });
  ...
  Route::prefix('ordenes-trabajo')->group(function () {
    ...
    Route::get('/{id}/detalle', [OrdenTrabajoController::class, 'detalle'])->name('ordenes-trabajo-detalle')->middleware('can:ver_ordenes');
    Route::put('/{id}', [OrdenTrabajoController::class, 'update'])->name('ordenes-trabajo-update')->middleware('can:ver_ordenes'); // Basic update
    Route::delete('/{id}', [OrdenTrabajoController::class, 'destroy'])->name('ordenes-trabajo-destroy')->middleware('can:eliminar_ordenes');

    // Sub-permissions
    Route::post('/{id}/fotografias', [OrdenTrabajoController::class, 'subirFotografia'])->name('ordenes-trabajo-subir-fotografia')->middleware('can:gestionar_fotos');
    Route::get('/{id}/fotografias', [OrdenTrabajoController::class, 'obtenerFotografias'])->name('ordenes-trabajo-obtener-fotografias')->middleware('can:ver_ordenes');
    Route::delete('/{ordenId}/fotografias/{fotografiaId}', [OrdenTrabajoController::class, 'eliminarFotografia'])->name('ordenes-trabajo-eliminar-fotografia')->middleware('can:gestionar_fotos');

    Route::post('/{id}/avanzar-etapa', [OrdenTrabajoController::class, 'avanzarEtapa'])->name('ordenes-trabajo-avanzar-etapa')->middleware('can:ver_ordenes');
    Route::post('/{id}/diagnostico', [OrdenTrabajoController::class, 'guardarDiagnostico'])->name('ordenes-trabajo-guardar-diagnostico')->middleware('can:gestionar_diagnostico');

    Route::post('/buscar-cotizacion-alegra', [OrdenTrabajoController::class, 'buscarCotizacionAlegra'])->name('ordenes-trabajo-buscar-cotizacion-alegra')->middleware('can:gestionar_cotizaciones');
    Route::post('/{id}/cotizaciones', [OrdenTrabajoController::class, 'agregarCotizacion'])->name('ordenes-trabajo-agregar-cotizacion')->middleware('can:gestionar_cotizaciones');
    Route::delete('/{ordenId}/cotizaciones/{cotizacionId}', [OrdenTrabajoController::class, 'eliminarCotizacion'])->name('ordenes-trabajo-eliminar-cotizacion')->middleware('can:gestionar_cotizaciones');
    Route::post('/{ordenId}/cotizaciones/{cotizacionId}/aprobar', [OrdenTrabajoController::class, 'aprobarCotizacion'])->name('ordenes-trabajo-aprobar-cotizacion')->middleware('can:gestionar_cotizaciones');

    Route::post('/buscar-orden-compra-alegra', [OrdenTrabajoController::class, 'buscarOrdenCompraAlegra'])->name('ordenes-trabajo-buscar-orden-compra-alegra')->middleware('can:gestionar_compras');
    Route::post('/{id}/ordenes-compra', [OrdenTrabajoController::class, 'agregarOrdenCompra'])->name('ordenes-trabajo-agregar-orden-compra')->middleware('can:gestionar_compras');
    Route::delete('/{ordenId}/ordenes-compra/{ordenCompraId}', [OrdenTrabajoController::class, 'eliminarOrdenCompra'])->name('ordenes-trabajo-eliminar-orden-compra')->middleware('can:gestionar_compras');

    Route::post('/buscar-factura-alegra', [OrdenTrabajoController::class, 'buscarFacturaAlegra'])->name('ordenes-trabajo-buscar-factura-alegra')->middleware('can:gestionar_facturacion');
    Route::post('/{id}/facturas', [OrdenTrabajoController::class, 'agregarFactura'])->name('ordenes-trabajo-agregar-factura')->middleware('can:gestionar_facturacion');
    Route::delete('/{ordenId}/facturas/{facturaId}', [OrdenTrabajoController::class, 'eliminarFactura'])->name('ordenes-trabajo-eliminar-factura')->middleware('can:gestionar_facturacion');

    Route::post('/{id}/entrega-repuestos', [OrdenTrabajoController::class, 'actualizarEntregaRepuestos'])->name('ordenes-trabajo-actualizar-entrega-repuestos')->middleware('can:gestionar_repuestos');
    Route::get('/{id}/imprimir-tiquete-repuestos', [TiqueteRepuestosController::class, 'generarPdf'])->name('ordenes-trabajo-imprimir-tiquete-repuestos')->middleware('can:gestionar_repuestos');

    Route::post('/{id}/cerrar', [OrdenTrabajoController::class, 'cerrarOrden'])->name('ordenes-trabajo-cerrar')->middleware('can:cerrar_orden');

    // Adjuntos y Comentarios
    Route::post('/{id}/adjuntos', [OrdenTrabajoController::class, 'subirAdjunto'])->name('ordenes-trabajo-subir-adjunto')->middleware('can:ver_ordenes');
    Route::delete('/{ordenId}/adjuntos/{adjuntoId}', [OrdenTrabajoController::class, 'eliminarAdjunto'])->name('ordenes-trabajo-eliminar-adjunto')->middleware('can:ver_ordenes');
    Route::post('/{id}/comentarios', [OrdenTrabajoController::class, 'agregarComentario'])->name('ordenes-trabajo-agregar-comentario')->middleware('can:ver_ordenes');
    Route::delete('/{ordenId}/comentarios/{comentarioId}', [OrdenTrabajoController::class, 'eliminarComentario'])->name('ordenes-trabajo-eliminar-comentario')->middleware('can:ver_ordenes');
  });

  // Finanzas
  Route::prefix('finanzas')->group(function () {
    Route::get('/', [FinanceController::class, 'index'])->name('finanzas.index');
    Route::get('/get-date-data', [FinanceController::class, 'getDataByDate'])->name('finanzas.get-date-data');
    Route::post('/store-daily', [FinanceController::class, 'storeDaily'])->name('finanzas.store-daily');
    Route::post('/store-provision', [FinanceController::class, 'storeProvision'])->name('finanzas.store-provision');
  });

  // Calendario
  Route::prefix('calendario')->group(function () {
    Route::get('/', [App\Http\Controllers\CalendarioController::class, 'index'])->name('calendario.index');
    Route::get('/events', [App\Http\Controllers\CalendarioController::class, 'getEvents'])->name('calendario.events');
  });
});